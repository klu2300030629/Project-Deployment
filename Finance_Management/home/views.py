...
def search(request):
    if request.session.has_key('is_logged'):
        ...
        return render(request,'home/HistoryHistory.html',{'addmoney':addmoney})
    return redirect('home')
def tables(request):
    if request.session.has_key('is_logged'):
        user_id = request.session["user_id"]
        ...
        return render(request,'home/History.html',{'addmoney':addmoney})
    return redirect('home')
...
def monthly(request):
    if request.session.has_key('is_logged') :
        ...
        return render(request,'home/monthly.html',{'addmoney':addmoney_info})
...
def yearly(request):
    return render(request,'home/yearly.html')
